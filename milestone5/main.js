...
(_a = document.getElementById('resumeform')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) {
    ...
    if (nameElement && emailElement && phoneElement && educationElement && experienceElement && skillsElement) {
        ...
        var profilePictureFile = (_a = profilePicture === null || profilePicture === void 0 ? void 0 : profilePicture.files) === null || _a === void 0 ? void 0 : _a[0];
            ...
            shareLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareableLink = "https://yourdownload.com/resume/".concat(name_1.replace(/\s+/g, '-').toLowerCase(), "_cv.html");
                            // Copy to clipboard
